    ...
    <body onload="myFunction()">
                ...
                <?php
                      ...
                      if(isset($_SESSION["username"])) {
                         echo $_SESSION['username'];
                            ...
                            echo ' <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTor6JlfMhQPrhCzFP41jsTHWHhcIb2qUYYJ7KzHfJ6-C1JwlOk&s" style="height:80;width:80;border-radius:50%;">';
                        }
                ?>
                </div>
                <div class = "site-nav">
        ...
        <div class = "sidenav" id = "sidenav">
            ...
            <?php 
                ...
                if(isset($_SESSION["username"])) {
                    echo '<button class = "btn log-in"><a href="logout.php" style="text-decoration: none;color:white;">logout</a></button>
                    ';
                }
                else {
                    echo '<button class = "btn log-in"><a href="login.php" style="text-decoration: none;color:white;">log in</a></button>
                    ';
                }
            ?>
        </div>
        ...
        <div class = "book">
            ...
            <form class = "book-form">
                ...
                <div class = "form-item">
                    <a href="book_now.php"> <input type = "button" class = "btn" value = "Book Now"></a>
                </div>
            </form>
            ...
            <div class = "sec-width">
                ...
                <div class = "customers-container">
                    ...
                    <div class = "customer">
                        ...
                        <span>Ed Sheeran, Great Britain</span>
                    </div>
